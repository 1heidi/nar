...
* Please read the associated openly available research article for context, additional details, and results: 
  ...
  * Imker, Heidi (2018): 25 Years of Molecular Biology Databases: A Study of Proliferation, Impact, and Maintenance. bioRxiv (see Illinois Data Bank page for link)

* The repository that accompanies the preprint and dataset is also available at:

  * https://github.com/1heidi/nar
...
* This dataset consists of 1 folder containing 32 files:
  * 1 Readme file (TXT)
...
**STEP 5** Purpose: Purpose: Determine issue level stats, including the average precent availability of databases 1991-2001 and maximum points of curvature
